...
open class AWWeekView: UIView {
    ...
    */
    open func setupCalendar(
        ...
        scrollType: AWWeekViewScrollType = .pageScroll,
...
extension AWWeekView: UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    private func paginationEffect(
        ...
        let pageWidth: CGFloat =
            scrollType == .sectionScroll ? flowLayout.sectionWidth : contentViewWidth
        ...
        let currentPage =
            scrollType == .sectionScroll ? currentSection : (currentSection >= numOfDays ? 1 : 0)  // The divider section for 0 and 1 page is at numOfDays
