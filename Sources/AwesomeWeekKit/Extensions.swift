...
extension UIView {
    ...
    func setAnchorConstraintsEqualTo(
    ...
    func setAnchorConstraintsEqualTo(
        widthAnchor: CGFloat? = nil,
        heightAnchor: CGFloat? = nil,
        topAnchor: (NSLayoutYAxisAnchor, CGFloat)? = nil,
        bottomAnchor: (NSLayoutYAxisAnchor, CGFloat)? = nil,
        leadingAnchor: (NSLayoutXAxisAnchor, CGFloat)? = nil,
        trailingAnchor: (NSLayoutXAxisAnchor, CGFloat)? = nil
    ) {
        ...
        if let trailingX = trailingAnchor {
            self.trailingAnchor.constraint(equalTo: trailingX.0, constant: trailingX.1).isActive =
                true
        }
    }

    func setAnchorCenterVerticallyTo(
        view: UIView,
        widthAnchor: CGFloat? = nil,
        heightAnchor: CGFloat? = nil,
        leadingAnchor: (NSLayoutXAxisAnchor, CGFloat)? = nil,
    ...
    func setAnchorCenterHorizontallyTo(
        view: UIView,
        widthAnchor: CGFloat? = nil,
        heightAnchor: CGFloat? = nil,
        topAnchor: (NSLayoutYAxisAnchor, CGFloat)? = nil,
    ...
    func setAnchorConstraintsFullSizeTo(view: UIView, padding: CGFloat = 0) {
        ...
        self.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: padding).isActive =
            true
        self.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -padding).isActive =
            true
    }
...
extension UILabel {
    class func getLabelWidth(_ height: CGFloat, font: UIFont, text: String) -> CGFloat {
        let label = UILabel(
            frame: CGRect(x: 0, y: 0, width: .greatestFiniteMagnitude, height: height)
        )
        label.font = font
...
extension Date {
    ...
    static func getCurrentWeekDays(firstDayOfWeek: AWDayOfWeek? = nil) -> [Date] {
    ...
    func getDayOfWeek() -> AWDayOfWeek {
        let weekDayNum = Calendar.current.component(.weekday, from: self)
        let weekDay = AWDayOfWeek(rawValue: weekDayNum)!
        return weekDay
    }
    ...
    static let components: Set<Calendar.Component> = [
