...
open class AWAllDayHeader: UICollectionReusableView {
    ...
    private func setupScrollView() {
        ...
        scrollView.setAnchorConstraintsEqualTo(
            topAnchor: (topAnchor, scrollViewPadding),
            leadingAnchor: (leadingAnchor, scrollViewPadding),
            trailingAnchor: (trailingAnchor, -scrollViewPadding)
        )
        let scrollViewBotCons = scrollView.bottomAnchor.constraint(
